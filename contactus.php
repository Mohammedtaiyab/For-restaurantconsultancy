...
<div id="fh5co-main"style="background-size: cover; background-image: linear-gradient(90deg,rgba(0,0,0,0.75) 0%,rgba(0,0,0,0) 100%),url(assets/img/pages/<?php echo $indexhead[0]['Bg_image']; ?>);" >
<div class="fh5co-narrow-content animate-box fadeInLeft animated" data-animate-effect="fadeInLeft">
        
        <div class="row">
          <div class="col-md-4 col-md-offset-1">
            <div class="et_pb_text_inner p-white" style="text-align:left">
              <h2>Get In Touch</h2>
              <p style="">You can write to us on</p>  <!--// (mail icon) hello@for-restaurantconsultancy.com ,  -->
              ...
              <p  style=""><img src="assets/img/whatsapp.png" style="width:6%;"><i class="fas fa-phone"style="animation: none;"></i> <span>+91 9 1052 1052 9</span></p>
          ...
          <div class="col-md-6">
                          ...
                          <input type="text" class="form-control effect-4" name="fname" placeholder="Full Name" required style="
...
">
                      ...
                      <div class="col-md-6">
                          <div class="form-group">
                          <input type="email" class="form-control effect-4" name="email" placeholder="Email" required style="
    border: 2px solid rgb(229 229 229) !important;
">
                          </div>
                      </div>
                      <div class="col-md-6">
                          <div class="form-group">
                          <input type="text" class="form-control effect-4" name="phone" placeholder="Phone Number" required style="
    border: 2px solid rgb(229 229 229) !important;
">
                          </div>
                      </div>
                      <div class="col-md-6">
                          <div class="form-group">
                          <input type="text" class="form-control effect-4" name="company" placeholder="Company Name" required style="
    border: 2px solid rgb(229 229 229) !important;
">
                          </div>
                      </div>
                      <div class="col-md-6">
                          <div class="form-group">
                          <input type="text" id="et_pb_contact_interested_in_0"  name="location" class="input form-control effect-4" placeholder="Location" required style="
    border: 2px solid rgb(229 229 229) !important;
">
                          </div>
                      </div>
           ...
           <p style="background:#78788c;color: #fff;">Your information is safe with us. We will never spam you!</p>
                      ...
                      <div class="col-md-4">
                          <div class="form-group">
                          <input type="submit" class="btn  btn-md  et_pb_button" name="contact" value="Send Message" style="width: auto;float: right;border-color: white;color: white;">

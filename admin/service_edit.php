			...
			<div class="page-content-wrapper">
				<div class="page-content">
					...
					<div class="page-breadcrumb d-none d-md-flex align-items-center mb-3">
						<div class="breadcrumb-title pr-3">Service </div>
						<div class="pl-3">
					...
					<div class="card radius-15">
						<div class="card-body">
							...
							<div class="input-group mb-3">
								...
								<input type="text" class="form-control" value='<?php echo $service[0]['Title']; ?>' aria-label="Username" aria-describedby="basic-addon1" disabled>
							</div>
...
<label for="basic-url">Paragraph</label>
		...
		CKEDITOR.replace( 'paragraph' );
							...
							<div class="input-group mb-3">
								...
								<div class="input-group-append">	<span class="input-group-text" id="basic-addon2">Side Image</span>
								</div>
							</div>
							
								<button class="btn btn-primary"  type="submit" name="sersec">Update</button>
							</form>
						</div>
					</div>
